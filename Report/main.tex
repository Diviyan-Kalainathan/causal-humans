...
\hline
 ...
 4 & \GLOB & 17.5\% & Changement de l'environnement de travail \\
  \hline
 5 & \ENV & 22.5\% &  Environnement stressant\\
  \hline
...
\begin{figure}[!h]
  \centering
  \subfloat[Graphe sans relation indirectes]{\includegraphics[width=6cm]{Pictures/graph_direct.pdf}}
  \hspace{2pt}
  \subfloat[Graphe avec relation indirectes]{\includegraphics[width=6cm]{Pictures/graph_indirect.pdf}}
